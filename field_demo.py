...
demo_field = Field()
test1 = CardTemplate()
init_card(test1,"Recruiter")
test2 = CardTemplate()
init_card(test2,"Web Master")
test3 = CardTemplate()
init_card(test3, "Editor")
test4 = CardTemplate()
init_card(test4, "Advisor")
test5 = CardTemplate()
init_card(test5, "Vice President")
test6 = CardTemplate()
init_card(test6, "Historian")
test7 = CardTemplate()
init_card(test7, "Treasurer")
test8 = CardTemplate()
init_card(test8, "Quartermaster")
test9 = CardTemplate()
init_card(test9, "Secretary")
core = CardTemplate()
init_card(core, "President")
demo_field.fl = test1
demo_field.fc = test2
demo_field.fr = test3
demo_field.ml = test4
